  ...
  Future<Map<String, dynamic>?> _onAuthorizer(
    ...
    try {
      ...
      final result = await dioConsumer.post(
        path:
            authEndPoint, // Note: DioConsumer expects path, check if authEndPoint is full URL or path.
        // If authEndPoint is full URL, DioConsumer might double-append baseUrl if not handled.
        // NetworkConfig says baseUrl is https://servicely.almasader.org/api
        // PusherConfig probably has relative paths? Need to check PusherConfig.
