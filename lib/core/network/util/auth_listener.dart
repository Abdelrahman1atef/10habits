...
void setupAuthListener() {
  sl<AuthInterceptor>().onUnauthorized.listen((_) {
    ...
    if (context != null) {
      ...
      // but Alerts.bottomSheet might handle it or we can add a flag here.
      // For now, we rely on the context being valid.
      Alerts.bottomSheet(context, child: const RequireAuthBottomSheet());
    }
  });
}
